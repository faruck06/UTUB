 ...
 * @author FaruckJ
 */
public class frm_Rol extends JPanel {
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                frm_Rol.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                frm_Rol.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                frm_Rol.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                frm_Rol.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<JPA.Rol> toRemove = new ArrayList<JPA.Rol>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            JPA.Rol r = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(r);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<JPA.Rol> merged = new ArrayList<JPA.Rol>(list.size());
            for (JPA.Rol r : list) {
    ...
    private java.util.List<JPA.Rol> list;
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new frm_Rol());
